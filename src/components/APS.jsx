    ...
    <section id="aps" className="section">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-base max-w-2xl mx-auto" style={{ color: 'rgba(245,245,248,0.5)' }}>
        ...
        <motion.div
          ...
          style={{ background: 'rgba(201,164,109,0.08)', border: '1px solid rgba(201,164,109,0.2)' }}
        >
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <div
                    ...
                    style={{ background: 'rgba(201,164,109,0.1)', border: '1px solid rgba(201,164,109,0.25)', color: '#C9A46D' }}
                  >
                    {step.num}
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm mb-4 leading-relaxed" style={{ color: 'rgba(245,245,248,0.5)' }}>{step.desc}</p>
                  <div className="space-y-1.5">
                    {step.details.map((d, j) => (
                      <div key={j} className="flex items-center gap-2 text-xs" style={{ color: 'rgba(245,245,248,0.55)' }}>
                        <div className="w-1 h-1 rounded-full flex-shrink-0" style={{ background: '#C9A46D' }} />
                        {d}
                      </div>
                    ))}
                  </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-white">APS India Office Locations</h3>
            <a
              href="https://www.aps-india.de"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg transition-all"
              style={{ color: '#C9A46D', background: 'rgba(201,164,109,0.1)', border: '1px solid rgba(201,164,109,0.2)' }}
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {offices.map((o, i) => (
              <div key={i} className="rounded-xl p-4" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <div className="text-xs px-2 py-1 rounded-md" style={{ background: 'rgba(201,164,109,0.08)', color: '#C9A46D' }}>{o.note}</div>
              </div>
            ))}
          </div>
        </motion.div>
