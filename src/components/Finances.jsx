...
export const costItems = [
  { icon: Home, label: 'Rent', munich: '€700–1,100', berlin: '€600–900', small: '€250–450', color: '#0A0A0A' },
  { icon: UtensilsCrossed, label: 'Food & Groceries', munich: '€200–350', berlin: '€200–320', small: '€180–280', color: '#0A0A0A' },
  { icon: Bus, label: 'Transport', munich: '€0 (semester)', berlin: '€0 (semester)', small: '€0 (semester)', color: '#444444' },
    ...
    <section id="finances" className="section">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="text-center">
              ...
              <div className="text-xs" style={{ color: 'rgba(0,0,0,0.38)' }}>Access only ≤€992/month</div>
            </div>
            <div className="text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
            {blockedBanks.map((b, i) => (
              <motion.div
                ...
                style={{
                  background: b.recommended ? 'rgba(0,0,0,0.03)' : 'rgba(0,0,0,0.02)',
                  border: b.recommended ? '1px solid rgba(0,0,0,0.1)' : '1px solid rgba(0,0,0,0.03)',
                }}
              >
                {b.recommended && (
        ...
        >
          ...
          <p className="text-xs mt-4" style={{ color: 'rgba(0,0,0,0.3)' }}>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.04)' }}>
                <Briefcase size={18} color="#0A0A0A" />
              </div>
              <h3 className="text-lg font-bold text-[#1A1A2E]">Student Work Rights</h3>
            </div>
            <div className="space-y-4">
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>Max days per year</span>
                <span className="font-bold text-[#1A1A2E]">120 full days</span>
              </div>
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>Half-day alternative</span>
                <span className="font-bold text-[#1A1A2E]">240 half days</span>
              </div>
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>During semester (typical)</span>
                <span className="font-bold text-[#1A1A2E]">~20 hrs/week</span>
              </div>
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>During semester break</span>
                <span className="font-bold text-[#1A1A2E]">40 hrs/week</span>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>Minimum wage (2024)</span>
                <span className="font-bold" style={{ color: '#444444' }}>€12.82/hour</span>
              </div>
            </div>
            <div className="mt-4 text-xs p-3 rounded-xl" style={{ background: 'rgba(0,0,0,0.03)', color: 'rgba(0,0,0,0.5)', border: '1px solid #E8E8E8' }}>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>Semester fee (avg)</span>
                <span className="font-bold text-[#1A1A2E]">€100–350</span>
              </div>
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>Health insurance</span>
                <span className="font-bold text-[#1A1A2E]">~€120/month</span>
              </div>
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>Student visa (India)</span>
                <span className="font-bold text-[#1A1A2E]">~₹7,000</span>
              </div>
              <div className="flex justify-between items-center py-3" style={{ borderBottom: '1px solid rgba(0,0,0,0.02)' }}>
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>APS certificate</span>
                <span className="font-bold text-[#1A1A2E]">~₹18,500</span>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-sm" style={{ color: 'rgba(0,0,0,0.45)' }}>Flight (India → DE)</span>
