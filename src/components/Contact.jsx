    ...
    <section id="contact" className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-4" style={{ letterSpacing: '-0.03em', color: '#0A0A0A' }}>
            Have a <span className="text-gold-gradient">question?</span>
          </h2>
          <p className="text-base max-w-xl mx-auto" style={{ color: 'rgba(0,0,0,0.4)' }}>
        ...
        <div
          ...
          style={{ background: 'rgba(0,0,0,0.02)', border: '1px solid #EEEEEE' }}
        >
          {status === 'success' ? (
            <div className="text-center py-10">
              <CheckCircle size={48} color="#0A0A0A" className="mx-auto mb-4" />
              <h3 className="text-xl font-bold text-[#1A1A2E] mb-2">Message sent!</h3>
              <p style={{ color: 'rgba(0,0,0,0.4)', fontSize: '14px' }}>We'll get back to you as soon as possible.</p>
              <button
                onClick={() => setStatus('idle')}
                className="mt-6 px-6 py-2.5 rounded-xl text-sm font-semibold"
                style={{ background: 'rgba(0,0,0,0.06)', color: '#0A0A0A', border: '1px solid rgba(0,0,0,0.1)' }}
              >
